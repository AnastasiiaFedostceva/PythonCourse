...
def test_lesson5_task_10_chrome(chrome_driver):
    Item.item_check(chrome_driver)

def test_lesson5_task_10_firefox(firefox_driver):
    Item.item_check(firefox_driver)

def test_lesson5_task_10_ie(edge_driver):
    Item.item_check(edge_driver)
